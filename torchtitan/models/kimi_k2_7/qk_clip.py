...
def _distributed_row_scales(
    ...
    """Represent TP-local row scales on the weight's storage mesh.

    Recording DP replication and TP sharding lets DTensor align the scales
    with finer-grained FlexShard ownership without another collective.
    """
